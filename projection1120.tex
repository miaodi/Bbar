...
To integrate \Bezier projection into a standard finite element assembly algorithm, it is convenient to recast \Bezier projection in terms of a dual basis. \added{It plays a key role in developing the non-symmetric \Bezier $\bar{B}$ method.} A dual basis has the distinguishing property that
\begin{align}
