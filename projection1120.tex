...
\paragraph{Remark} \added{From the stiffness matrix of the symmetric \Bezier $\bar{B}$ formulation \eqref{eqn:symmetric_b_bar_timoshenko_stiffness}, we can recover its mixed formulation as}
...
\end{equation}
\added{which shows the conflict between the symmetric \Bezier $\bar{B}$ formulation and the mixed formulation.}
